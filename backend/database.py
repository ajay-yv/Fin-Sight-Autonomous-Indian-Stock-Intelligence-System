...
class SocialSentimentRow(Base):
    ...
    volume_spike: Mapped[bool] = mapped_column(Integer, nullable=False, default=0)
    timestamp: Mapped[datetime] = mapped_column(DateTime, nullable=False)


class OptionsFlowRow(Base):
    ...
    gex: Mapped[float] = mapped_column(Float, nullable=False)
    timestamp: Mapped[datetime] = mapped_column(DateTime, nullable=False)
